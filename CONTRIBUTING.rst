...
Thank you for your help improving **ipygee**!

**ipygee** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **ipygee** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/<YOUR USERNAME>/ipygee
   cd ipygee
...
This will install the **ipygee** library, together with two additional tools:
